      ...
      <Container>
        <Navbar.Brand href="#home" className="d-flex align-items-center">
          <img
            ...
            className="me-3"
          />
          <span style={{ fontFamily: "monospace", fontSize: "36px", letterSpacing: "5px", color: "#f8c22e" }}>Ficatio</span>
        </Navbar.Brand>
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto align-items-center">
            <Nav.Link href="#home" className="fs-5 text-light mx-3">Home</Nav.Link>
